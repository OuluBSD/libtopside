...
struct MotionControllerComponent : Component<MotionControllerComponent>
{
    ...
    winrt::Windows::UI::Input::Spatial::SpatialInteractionSourceHandedness req_hand{ winrt::Windows::UI::Input::Spatial::SpatialInteractionSourceHandedness::Unspecified };
