...
Shared<DX::DeviceResources> HolographicRenderer::GetDeviceResources()
{
...
void HolographicRenderer::Initialize()
{
    ...
    pbr_res->SetLight(XMVECTORF32{ 0.0f, 0.7071067811865475f, -0.7071067811865475f }, Colors::White);
}
