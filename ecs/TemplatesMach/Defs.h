...
#define TMPL_DEVLIB_CTOR	template <class DevSpec> ScopeDevLibT<DevSpec>::
...
#define TMPL_CONVDEVLIB(x)	template <class FromDevSpec, class ToDevSpec> x ScopeConvDevLibT<FromDevSpec,ToDevSpec>::
#define TMPL_CONVVALDEVLIB(x)	template <class ValSpec, class FromDevSpec, class ToDevSpec> x ScopeConvValDevLibT<ValSpec,FromDevSpec,ToDevSpec>::
