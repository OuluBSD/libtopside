...
static bool MotionController_Send(NativeMotionController& ctrl, AtomBase&, PacketValue& out);
...
static bool MotionControllerSystem_Send(NativeMotionControllerSystem& sys, AtomBase&, PacketValue& out);
...
static bool AppView_Send(AtomBase&, PacketValue& out);
...
static bool CameraResources_Send(AtomBase&, PacketValue& out);
...
static bool ControllerModelCache_Send(AtomBase&, PacketValue& out);
...
static bool DeviceResources_Send(AtomBase&, PacketValue& out);
...
static bool HolographicRenderer_Send(AtomBase&, PacketValue& out);
...
static bool HolographicScene_Send(AtomBase&, PacketValue& out);
...
static bool SpatialInteractionSystem_Send(AtomBase&, PacketValue& out);
...
static bool Renderer_Send(AtomBase&, PacketValue& out);
