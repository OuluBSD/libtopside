...
static bool MotionController_ProcessPacket(NativeMotionController& ctrl, AtomBase&, PacketValue& v);
...
static bool MotionControllerSystem_ProcessPacket(NativeMotionControllerSystem& sys, AtomBase&, PacketValue& v);
...
static bool AppView_ProcessPacket(AtomBase&, PacketValue& v);
...
static bool CameraResources_ProcessPacket(AtomBase&, PacketValue& v);
...
static bool ControllerModelCache_ProcessPacket(AtomBase&, PacketValue& v);
...
static bool DeviceResources_ProcessPacket(AtomBase&, PacketValue& v);
...
static bool HolographicRenderer_ProcessPacket(AtomBase&, PacketValue& v);
...
static bool HolographicScene_ProcessPacket(AtomBase&, PacketValue& v);
...
static bool SpatialInteractionSystem_ProcessPacket(AtomBase&, PacketValue& v);
