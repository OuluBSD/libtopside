...
static bool MotionController_ProcessPacket(NativeMotionController& ctrl, AtomBase&, PacketValue& in, PacketValue& out);
...
static bool MotionControllerSystem_ProcessPacket(NativeMotionControllerSystem& sys, AtomBase&, PacketValue& in, PacketValue& out);
...
static bool AppView_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
...
static bool CameraResources_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
...
static bool ControllerModelCache_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
...
static bool DeviceResources_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
...
static bool HolographicRenderer_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
...
static bool HolographicScene_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
...
static bool SpatialInteractionSystem_ProcessPacket(AtomBase&, PacketValue& in, PacketValue& out);
