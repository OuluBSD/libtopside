...
static void ReserveTexture(GVar::TextureType type, FramebufferT<Gfx>& fb);
static void SetTexture(GVar::TextureType type, Size sz, GVar::Sample sample, int ch, const byte* data);
static void SetTexture(GVar::TextureType type, Size3 sz, GVar::Sample sample, int ch, const byte* data);
