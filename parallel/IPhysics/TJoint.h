#ifndef _IPhysics_TJoint_h_
#define _IPhysics_TJoint_h_
...
public:
	...
	void AttachHinge(Object& portal, Object& face) {
		Fys::AttachJoint(joint, portal.body, face.body);
