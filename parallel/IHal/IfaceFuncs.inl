...
static bool AudioSinkDevice_ProcessPacket(NativeAudioSinkDevice& dev, AtomBase&, PacketValue& v);
...
static bool ContextBase_ProcessPacket(NativeContextBase& ctx, AtomBase&, PacketValue& v);
