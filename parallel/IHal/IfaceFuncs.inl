...
static bool AudioSinkDevice_Send(NativeAudioSinkDevice& dev, AtomBase&, PacketValue& out);
...
static bool CenterVideoSinkDevice_Send(NativeVideoSink& dev, AtomBase&, PacketValue& out);
...
static bool CenterFboSinkDevice_Send(NativeSw3dVideoSink& dev, AtomBase&, PacketValue& out);
...
static bool OglVideoSinkDevice_Send(NativeOglVideoSink& dev, AtomBase&, PacketValue& out);
...
static bool ContextBase_Send(NativeContextBase& ctx, AtomBase&, PacketValue& out);
...
static bool EventsBase_Send(NativeEventsBase& ctx, AtomBase&, PacketValue& out);
