...
static bool Image_PostInitialize(NativeImage& dev, AtomBase&);
...
static bool Image_Send(NativeImage& dev, AtomBase&, RealtimeSourceConfig& cfg, PacketValue& out, int src_ch);
