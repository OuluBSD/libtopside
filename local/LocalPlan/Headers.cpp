...
void InterfaceBuilder::Headers() {
	...
	AddCustomBase("VideoGenBase");
	AddCustomBase("FfmpegSourceDevice", "FFMPEG");
	AddCustomBase("EventStateBase", "SCREEN");
	AddCustomBase("EcsVideoBase", "SCREEN");
	AddCustomBase("X11SwFboBase", "SCREEN&POSIX");
	AddCustomBase("X11OglFboBase", "OGL&POSIX");
	AddCustomBase("SdlOglFboBase", "SDL2&OGL&SCREEN");
	AddCustomBase("X11SwShaderBase", "POSIX");
	AddCustomBase("X11OglShaderBase", "OGL&POSIX");
	AddCustomBase("SdlOglShaderBase", "SDL2&OGL&SCREEN");
	AddCustomBase("TestEventSrcBase");
	AddCustomBase("SdlOglImageBase", "SDL2&OGL&SCREEN");
	AddCustomBase("SdlOglTextureBase", "SDL2&OGL&SCREEN");
	AddCustomBase("SdlOglFboReaderBase", "SDL2&OGL&SCREEN");
	AddCustomBase("SdlOglKeyboardBase", "SDL2&OGL&SCREEN");
	AddCustomBase("SdlOglAudioBase", "SDL2&OGL&SCREEN");
