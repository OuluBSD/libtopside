...
void OglDrawFramebuffer::DrawLineOp(int x1, int y1, int x2, int y2, int width, Color color) {
	TODO
}

void OglDrawFramebuffer::DrawRectOp(int x, int y, int cx, int cy, Color color) {
	TODO
}

void OglDrawFramebuffer::DrawTextOp(int x, int y, int angle, const wchar *text, Font font,
	                        Color ink, int n, const int *dx) {
	TODO
}

void OglDrawFramebuffer::DrawPolyPolylineOp(const Point *vertices, int vertex_count,
                                    const int *counts, int count_count,
                                    int width, Color color, Color doxor) {
	TODO
}

bool OglDrawFramebuffer::ClipOp(const Rect& r) {
	TODO
}

void OglDrawFramebuffer::EndOp() {
	TODO
}
