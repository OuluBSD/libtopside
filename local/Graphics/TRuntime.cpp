...
GFX_EXCPLICIT_INITIALIZE_CLASS(CompilerT)
GFX_EXCPLICIT_INITIALIZE_CLASS(LinkerT)
GFX_EXCPLICIT_INITIALIZE_CLASS(ShaderStateT)
GFX_EXCPLICIT_INITIALIZE_CLASS(ShaderT)
GFX_EXCPLICIT_INITIALIZE_CLASS(ShaderPipelineT)
GFX_EXCPLICIT_INITIALIZE_CLASS(RuntimeStateT)
GFX_EXCPLICIT_INITIALIZE_CLASS(FramebufferStateExtT)
