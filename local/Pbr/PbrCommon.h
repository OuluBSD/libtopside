...
struct PrimitiveBuilder
{
    ...
    PrimitiveBuilder& AddSphere(float diameter, uint32 tessellation, Pbr::NodeIndex_t transform_idx = Pbr::RootNodeIndex);
    PrimitiveBuilder& AddCube(float sideLength, Pbr::NodeIndex_t transform_idx = Pbr::RootNodeIndex);
};
