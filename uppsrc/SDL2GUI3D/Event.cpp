...
bool SDL2GUI3D::IsMouseIn()
{
	return sdlMouseIsIn;
}

dword SDL2GUI3D::GetMouseButtons()
{
	return mouseb;
}

dword SDL2GUI3D::GetModKeys()
{
	return modkeys;
}
...
bool SDL2GUI3D::ProcessEvent(bool *quit)
{
	bool ret = false;
	SDL_Event event;
...
void SDL2GUI3D::WaitEvent(int ms)
{
	SDL_WaitEventTimeout(NULL, ms);
}

bool SDL2GUI3D::IsWaitingEvent()
{
	SDL_PumpEvents();
	SDL_Event events;
...
void SDL2GUI3D::WakeUpGuiThread()
{
