...
HEADER11(			TestRealtimeSink,	CenterSink,		sink,		CenterAudio,	CenterAudio,	CenterReceipt)
...
HEADER11(			AudioHardwareSink,	CenterSink,		sink,		CenterAudio,	CenterAudio,	CenterReceipt)
...
HEADER12(			AudioSplitter,		CenterSource,		side_source,	CenterAudio,	CenterAudio,	CenterAudio,	CenterReceipt)
...
HEADER21(			AudioJoiner,		CenterSink,		side_sink,		CenterAudio,	CenterOrder,	CenterAudio,	CenterAudio)
...
/*HEADER11(			VideoHardwareSink,	AccelSink,				sink,		AccelVideo,		AccelReceipt)
...
HEADER11(			SdlEventAtomSA,		CenterSink,		sink,		CenterEvent,	CenterOrder,	CenterReceipt)
...
HEADER11(			SdlVideoAtomSA,		AccelSink,		sink,		AccelVideo,		AccelOrder,		AccelReceipt)
...
HEADER11(			SdlVideoAtom,		AccelSink,		sink,		AccelVideo,		AccelVideo,		AccelReceipt)
...
/*HEADER11(			SideSdlVideoAtom,	AccelSink,		sink,		AccelVideo,		AccelVideo,		AccelReceipt)
HEADER_INHERITS(	SideSdlVideoAtom,	SDL2ScreenBase)
HEADER_ACTION(		SideSdlVideoAtom,	sdl.video.with.buf0)*/

HEADER11(			SdlSwVideoAtom,		CenterSink,		sink,		CenterVideo,	CenterVideo,	CenterReceipt)
...
HEADER11(			OglShaderSource,	AccelSource,		source,		AccelVideo,		AccelOrder,		AccelVideo)
...
/*HEADER12(			OglShaderBuffer,	AccelSource,		side_source,	AccelVideo,		AccelOrder,		AccelVideo,		AccelReceipt)
