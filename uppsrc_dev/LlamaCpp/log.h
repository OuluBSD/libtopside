...
inline void log_test()
{
    ...
    log_enable();
    LOG(Format("02 Hello World to default output, which is \"%s\" ( Yaaay, arguments! )!", LOG_STRINGIZE(LOG_TARGET)));
    ...
    LOG_TEE("16 Hello msvc TEE with (%d)(%s) arguments", 1, "test");
    LOG_TEELN("17 Hello msvc TEELN without arguments");
    LOG_TEELN("18 Hello msvc TEELN with (%d)(%s) arguments", 1, "test");
    LOG("19 Hello msvc LOG without arguments");
    LOG("20 Hello msvc LOG with (%d)(%s) arguments", 1, "test");
    LOGLN("21 Hello msvc LOGLN without arguments");
    LOGLN("22 Hello msvc LOGLN with (%d)(%s) arguments", 1, "test");
#endif
}
