...
public:
	...
	void affine_3point_transform(mat, src_x0, src_y0, dst_x0, dst_y0,
	...
	void perspective_4point_transform(mat, src_x0, src_y0, dst_x0, dst_y0,
			src_x1, src_y1, dst_x1, dst_y1,
			src_x2, src_y2, dst_x2, dst_y2,
	...
	void invert_affine_transform(src, dst) {
	...
	void invert_perspective_transform(src, dst) {
		double m11 = src[0], m12 = src[1], m13 = src[2];
		double m21 = src[3], m22 = src[4], m23 = src[5];
