...
public:
	...
	matrix_t H(3, 3, F32_t | C1_t);
	matrix_t patch_img(32, 32, U8_t | C1_t);
	
	void rectify_patch(src, dst, angle, px, py, psize) {
	...
	vpod describe(src, corners, count, descriptors) {
