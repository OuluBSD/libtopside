...
#define ATOM_TYPE_LIST \
	...
	ATOM_TYPE(WIN_DX_CONTEXT_ATOM) \
	ATOM_TYPE(WIN_DX_FBO_PROG) \
	ATOM_TYPE(WIN_DX_FBO_ATOM_PIPE) \
	ATOM_TYPE(WIN_DX_FBO_ATOM_SA) \
...
#define ATOM_CLASS_LIST \
	...
	ATOM_CLASS(WinDxContextAtom) \
	ATOM_CLASS(WinDxFboProg) \
	ATOM_CLASS(WinDxFboAtomPipe) \
	ATOM_CLASS(WinDxFboAtomSA) \
