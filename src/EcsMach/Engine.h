...
#define ECS_SYS_DEF_VISIT void Visit(RuntimeVisitor& vis) override {vis.VisitThis<Ecs::System<CLASSNAME>>(this);}
#define ECS_SYS_DEF_VISIT_DERIVED(x) void Visit(RuntimeVisitor& vis) override {vis.VisitThis<x>(this);}
#define ECS_SYS_DEF_VISIT_(x) void Visit(RuntimeVisitor& vis) override {x; vis.VisitThis<Ecs::System<CLASSNAME>>(this);}
