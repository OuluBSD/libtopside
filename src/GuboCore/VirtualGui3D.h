#ifndef _GuboCore_VirtualGui3D_h_
#define _GuboCore_VirtualGui3D_h_
...
struct VirtualGui3D {
	virtual bool        Poll(UPP::SurfaceEvent& e) = 0;
...
struct VirtualSurface : RTTIBase {
	RTTI_DECL0(VirtualSurface)
...
#define GUIPLATFORM_CTRL_TOP_DECLS   Surface *owner_window;
