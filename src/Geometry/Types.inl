...
const dword CALIBDATA_O = PKG_GEOMETRY_V  | 19;
const dword SQUARE_O    = PKG_GEOMETRY_V  | 20;

#endif

OBJ_TYPE_NO(vec2,   VEC2_O)
OBJ_TYPE_NO(vec3,   VEC3_O)
OBJ_TYPE_NO(vec4,   VEC4_O)
OBJ_TYPE_NO(ivec2,  IVEC2_O)
OBJ_TYPE_NO(ivec3,  IVEC3_O)
OBJ_TYPE_NO(ivec4,  IVEC4_O)
...
OBJ_TYPE_NO(CalibrationData,   CALIBDATA_O)
OBJ_TYPE_NO(Square, SQUARE_O)
