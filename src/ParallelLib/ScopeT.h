...
public:
	...
	HandleSystem* GetManager() const {return this->GetParentUnsafe().Get()->Get();}
	...
	int GetPosId(int handle_pos) {if (handle_pos >= 0 && handle_pos < handles.GetCount()) return handles.GetKey(handle_pos); return -1;}
