...
#define INITBLOCK void LINEID(Init,MK__s) (); static Oulu::Callinit LINEID(initcb,MK__s) (LINEID(Init,MK__s)); void LINEID(Init,MK__s) ()
#define EXITBLOCK void LINEID(Exit,MK__s) (); static Oulu::Callexit LINEID(exitcb,MK__s) (LINEID(Exit,MK__s)); void LINEID(Exit,MK__s) ()
#define INITBLOCK_(x) void LINEID(Init,x) (); static Oulu::Callinit LINEID(initcb,x) (LINEID(Init,x)); void LINEID(Init,x) ()
#define EXITBLOCK_(x) void LINEID(Exit,x) (); static Oulu::Callexit LINEID(exitcb,x) (LINEID(Exit,x)); void LINEID(Exit,x) ()
