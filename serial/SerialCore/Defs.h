...
#define ATOM_MAKE_ACTION_BEGIN static bool MakeAction(const TypeAtomCls& cls, Script::Action& act) {bool fail = false, any_changes = false; const ValDevCls& vd = cls.side.vd;
