...
//
LomseDoorway    lomse;        //the Lomse library doorway
Presenter*      presenter;	//relates the View, the Document and the Interactor
...
void open_document()
{
    ...
    delete presenter;
    presenter = lomse.new_document(k_view_vertical_book,
        "(lenmusdoc (vers 0.0)"
            "(content "
    ...
    if (SpInteractor spInteractor = presenter->get_interactor(0).lock())
    {
...
void initialize_lomse()
{
    ...
    lomse.init_library(m_format, 96);   //resolution=96 ppi
...
int main ()
{
    ...
    delete_rendering_buffer();
    delete presenter;    //this will also delete the Doc, the Views and all other stuff
