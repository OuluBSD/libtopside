...
ModalBar::ModalBar()
	...
	wave_->SetRate( 0.5 * 22050.0 / Audio::GetSampleRate() );
	this->SetPreset( 0 );
}
...
void ModalBar::SetStickHardness( double hardness ) {
...
void ModalBar::SetStrikePosition( double position ) {
	...
	double temp2 = position * PI;
	double temp = sin(temp2);
